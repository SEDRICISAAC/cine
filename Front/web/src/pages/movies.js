                        ...
                        { peliculas.map(element => 
                            <div className="max-w-md w-full lg:flex" key={ element.id }>
                                ...
                                <div className="border-r border-b border-l border-grey-light lg:border-l-0 lg:border-t lg:border-grey-light bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                                    <div className="mb-8">
                                        <div className="text-black font-bold text-xl mb-2 italic">Título: { element.titulo }</div>
                                    ...
                                    <div className="m-3">
                                        <button className="bg-white text-black  border-b-2 bg-green-500 hover:border-green-600 hover:bg-white hover:text-black shadow-md py-2 px-6 inline-flex items-center">
                                    ...
                                    <div className="m-3">
                                        <button className="bg-white text-black  border-b-2  hover:border-red-600 hover:bg-red-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center"
